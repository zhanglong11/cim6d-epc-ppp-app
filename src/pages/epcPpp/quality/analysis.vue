<template>
  <view class="main" style="padding-top: 10rpx;">
    <block v-if="filterForm.diff">
      <QualityIssueDiff></QualityIssueDiff>
    </block>
...
import QualityIssueDiff from '@/pages/epcPpp/quality/components/QualityIssueDiff'
import IssueYear from '@/pages/epcPpp/quality/components/IssueYear'
import IssueMonth from '@/pages/epcPpp/quality/components/IssueMonth'
import Api from '@/pages/epcPpp/quality/api'
export default {
  name: 'Manage',
  components: { QualityIssueDiff, IssueYear, IssueMonth },
  data() {
    return {
