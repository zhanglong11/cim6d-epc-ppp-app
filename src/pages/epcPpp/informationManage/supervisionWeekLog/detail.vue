    ...
    <scroll-view class="scroll-roll" scroll-y>
      <view class="main-body">
        <view>
          ...
          <uni-card isForm title="">
            <uni-form-item label="上周工作完成情况" type="textarea" align="left" class="block-item">
              <view class="disabled">{{ info.workFinishSituation }}</view>
            </uni-form-item>
            <uni-form-item label="下周工作计划" type="textarea" align="left" class="block-item">
              <view class="disabled">{{ info.nextWorkPlan }}</view>
            </uni-form-item>
            <uni-form-item label="工程质量情况" type="textarea" align="left" class="block-item">
              <view class="disabled">{{ info.qualitySituation }}</view>
            </uni-form-item>
            <uni-form-item label="工程安全文明情况" type="textarea" align="left" class="block-item">
              <view class="disabled">{{ info.securityCivilization }}</view>
            </uni-form-item>
...
export default {
  name: 'EpcPPPSupervisionLogDetail',
  components: {},
  data() {
    return {
      statusList,
  ...
  onNavigationBarButtonTap(obj) {
    this.$utils.toUrl(`/pages/epcPpp/informationManage/supervisionWeekLog/add?id=${this.id}`)
  },
  onLoad(options) {
    this.id = options.id
    this.init()
