...
export default {
  ...
  methods: {
    ...
    //添加日志
    handleAdd() {
      this.$utils.toUrl('/pages/epcPpp/informationManage/supervisionDayLog/add')
    },
    handleItemClick(row) {
        //未取消
        this.$utils.toUrl(`/pages/epcPpp/informationManage/supervisionDayLog/detail?id=${row.id}`)
    },
